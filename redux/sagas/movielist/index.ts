...
import {
  ...
  movieListSuccess,
  movieListFailure,
} from "../../reducer/movielist";
import {
  movieDetailSuccess,
  movieDetailFailure,
  getMovieDetail,
} from "../../reducer/moviedetail";
import {
  getPopularMovie,
  popularMovieSuccess,
  popularMovieFailure,
} from "../../reducer/popularmovie";
import {
  getTopRatedMovie,
  topRatedMovieSuccess,
  topRatedMovieFailure,
} from "../../reducer/toprated";
import {
  getUpComingMovie,
  upcomingMovieSuccess,
  upComingMovieFailure,
} from "../../reducer/upcoming";
import {
  getSimilarMovie,
  similarMovieSuccess,
  similarMovieFailure,
} from "../../reducer/similarmovie";
import { getArtist, artistSuccess, artistFailure } from "../../reducer/artist";
import {
  getArtistDetail,
  artistDetailSuccess,
  artistDetailFailure,
} from "../../reducer/artistdetail";
...
const combineSagas = [
  ...
  takeEvery(getTopRatedMovie.type, topRatedMovieListApi),
  takeEvery(getUpComingMovie.type, upComingMovieListApi),
  takeEvery(getMovieDetail.type, movieDetailApi),
  takeEvery(getSimilarMovie.type, similarMovieApi),
  takeEvery(getArtist.type, artistApi),
  takeEvery(getArtistDetail.type, artistDetailApi),
];
